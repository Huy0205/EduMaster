        ...
        <Grid container spacing={2} alignItems="center" justifyContent="center">
          ...
          <Grid item xs={12} md={3}>
            <TextField
              ...
              onChange={(e) =>
                setSelectedSubject(courses.find((course) => course.id === e.target.value))
              }
              variant="outlined"
            >
              {courses.map((course) => (
          ...
          <Grid item xs={12} md={3}>
            <TextField
              ...
              onChange={(e) =>
                setSelectedTopic(topics.find((topic) => topic.id === e.target.value))
              }
              variant="outlined"
            >
              {topics.map((topic) => (
          ...
          <Grid item xs={12} md={3}>
            <TextField
              ...
              onChange={(e) =>
                setSelectedQuiz(quizzes.find((quiz) => quiz.id === e.target.value))
              }
              variant="outlined"
            >
              {quizzes.map((quiz) => (
