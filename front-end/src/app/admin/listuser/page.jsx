...
import { Box, Typography, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, IconButton, Paper, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, TextField, Button } from '@mui/material';
...
const ListUserPage = () => {
  ...
  const handleUpdate = async () => {
    try {
      ...
      await axios.put(`http://localhost:8080/api/v1/user/update/${currentUser.id}`, currentUser);
