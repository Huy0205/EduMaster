            ...
            <Toolbar sx={{ justifyContent: 'center' }}>
                <Button
                    ...
                    sx={{
                        ...
                        fontSize: '16px',
                        '&:hover': {
                            bgcolor: pathname.startsWith('/ontap') ? 'green.400' : 'grey.400',
                ...
                <Button
                    ...
                    sx={{
                        ...
                        fontSize: '16px',
                        '&:hover': {
                            bgcolor: pathname.startsWith('/kiemtra') ? 'green.400' : 'grey.400',
                        }, // Hiệu ứng hover tùy vào trang
                    }}
                ...
                <Button
                    ...
                    sx={{
                        ...
                        fontSize: '16px',
                        '&:hover': {
                            bgcolor: pathname.startsWith('/doithuong') ? 'green.400' : 'grey.400',
                        },
                    }}
